...
@interface Mappa : UIViewController<MKMapViewDelegate,UIApplicationDelegate,UIAlertViewDelegate,UIActionSheetDelegate,NSXMLParserDelegate,CLLocationManagerDelegate> {
